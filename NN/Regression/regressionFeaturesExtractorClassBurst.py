...
OUTPUT_DATASET = 'regression_dataset_class_burst.csv'
OUTPUT_REPORT = 'regression_dataset_class_burst_report.txt'
    ...
    try:
        ...
        for idx, data in intervals.items():
            ...
            row = {
                ...
                'Bursts_Per_Class': data['burst_count'] / max(1, unique_classes),
